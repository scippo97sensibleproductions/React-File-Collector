...
const fileGroupDefinitions: Record<string, Omit<FileGroupInfo, 'key'>> = {
    ...
    javascript: {label: 'JavaScript', icon: <IconBrandJavascript size={18}/>, color: 'yellow'},
    typescript: {label: 'TypeScript', icon: <IconBrandTypescript size={18}/>, color: 'blue'},
    react: {label: 'React (TSX/JSX)', icon: <IconBrandReact size={18}/>, color: 'cyan'},
...
const languageData: FileTypeDefinition[] = [
    ...
    {"name": "C#", "type": "programming", "extensions": [".cs", ".csx"]},
    {"name": "CSHTML", "type": "markup", "extensions": [".cshtml"]},
    {"name": "Cake", "type": "programming", "extensions": [".cake"]},
    {
        "name": "C++",
        "type": "programming",
    ...
    {"name": "Rouge", "type": "programming", "extensions": [".rg"]},
    {
        "name": "Ruby",
        "type": "programming",
        "extensions": [".rb", ".builder", ".fcgi", ".gemspec", ".god", ".irbrc", ".jbuilder", ".mspec", ".pluginspec", ".podspec", ".rabl", ".rake", ".rbuild", ".rbw", ".rbx", ".ru", ".ruby", ".thor", ".watchr"]
    },
    ...
    {"name": "TypeScript", "type": "programming", "extensions": [".ts"]},
    {"name": "TSX", "type": "programming", "extensions": [".tsx"]},
